-- --------------------------------------------------------
-- INVENTORY SYSTEM - SQLITE SCHEMA
-- Branding: Rabella-System | Copyright: Rabella
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS products (
    ...
    legal_category TEXT DEFAULT 'OTC',
...
CREATE TABLE IF NOT EXISTS product_batches (
    ...
    expiry_date TEXT NOT NULL, -- SQLite uses TEXT for dates
...
-- 12. Unit Conversions Table (Future Use)
